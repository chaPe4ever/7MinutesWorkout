...
class BMIActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding?.rgUnits?.setOnCheckedChangeListener { _, checkedId: Int ->
            ...
            // Here if the checkId is METRIC UNITS view then make the view visible else US UNITS
            // view.
    ...
    private fun calculateUnits() {
        if (currentVisibleView == METRIC_UNITS_VIEW) {
            ...
            if (validateMetricUnits()) {
                ...
                // The height value is converted to float value and divided by 100 to convert it to
                // meter.
            ...
            if (validateUsUnits()) {
                ...
                val usUnitHeightValueFeet: String =
                        binding?.etUsMetricUnitHeightFeet?.text
                                .toString() // Height Feet value entered in EditText component.
                val usUnitHeightValueInch: String =
                        binding?.etUsMetricUnitHeightInch?.text
                                .toString() // Height Inch value entered in EditText component.
                ...
                // Here the Height Feet and Inch values are merged and multiplied by 12 for
