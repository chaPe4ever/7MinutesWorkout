...
class FinishActivity : AppCompatActivity() {
    ...
    private fun addDateToDatabase(historyDao: HistoryDao) {
        ...
        /**
         * Here we have taken an instance of Date Formatter as it will format our selected date in
         * the format which we pass it as an parameter and Locale. Here I have passed the format as
         * dd MMM yyyy HH:mm:ss.
         *
         * The Locale : Gets the current value of the default locale for this instance of the Java
         * Virtual Machine.
         */
